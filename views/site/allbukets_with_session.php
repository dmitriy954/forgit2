...
if ($idcat > -1) // в контроллекре filtercontroller тоже задействовано
  {
    $st2 = Url::to(['site/allbukets', 'page' => '1', 'per-page' => '12', 'unioncat' => $idcat]);
  }
  else {
	  
	       if ($searchq === -1) {
			     $st2 = Url::to(['site/allbukets', 'page' => '1', 'per-page' => '12']);  
				 }
		   else
		       {
			  	 $st2 = Url::to(['site/allbukets', 'page' => '1', 'per-page' => '12', 'searchq' => $searchq]); 
		       }
...
<div class="col-md-3 col-sm-4 col-sm-push-8 col-md-push-9 sidebar-offcanvas" id="sidebar">
   <div class="bx-sidebar-block">
	  ...
	  <div class="col-sm-12 tooglefilt">
		<a href=" <?php echo Url::to(['site/allbukets', 'price' => 1]); ?>" class="btn btn-danger btn-md btn-block" style="margin-bottom: 10px;">до 2000 <i class="fa fa-rub"></i></a>
	  </div>
	  <div class="col-sm-12 tooglefilt">
		<a href="<?php echo Url::to(['site/allbukets', 'price' => 2]); ?>" class="btn btn-success btn-md btn-block" style="margin-bottom: 10px;">2000 - 4000 <i class="fa fa-rub"></i></a>
	  </div>
	  <div class="col-sm-12 tooglefilt">
		<a href="<?php echo Url::to(['site/allbukets', 'price' => 3]); ?>" class="btn btn-success btn-md btn-block" style="margin-bottom: 10px;">4000 - 6000 <i class="fa fa-rub"></i></a>
	   </div>
	  <div class="col-sm-12 tooglefilt">
	 
		<a href="<?php echo Url::to(['site/allbukets', 'id' => 86]); ?>" class="btn btn-warning btn-md btn-block" style="margin-bottom: 20px;"><b>VIP</b></a>
	   </div>
      </div>
			...
			<div class = "row">
			   ...
			   <div id="modef1" class="bx-filter-popup-result left" >
                  ...
                  <span class="arrow"></span>
                    <br>
                  <a href="javascript:void(0)" onclick = "SubmitMyFormBuk()" target="">Показать</a>
              ...
              <div class="col-xs-12 bx-filter-button-box">
                 <div class="bx-filter-block">
                     <div class="bx-filter-parameters-box-container">
                         <input id="set_filter" class="btn btn-success " style = "float: right;" name="set_filter" value="Показать" type="button" onclick = "SubmitMyFormBuk()" >
...
<div class="col-md-9 col-sm-8 col-sm-pull-4 col-md-pull-3">
	...
	<?php if (isset($unioncatid) ) {  ?>   
	
	<div class="bx-title_div">
<h1 id="pagetitle" class="bx-title dbg_title"><?php if ($unioncatid == 1) { echo "Повод: ";}  
...
<?php
    ...
    <?= $form->field($filterdata, 'sort2', [ 'labelOptions' => ['class' => 'hidelabelmy']])->hiddenInput(['value' => $filterdata->sort2]);   ?>
